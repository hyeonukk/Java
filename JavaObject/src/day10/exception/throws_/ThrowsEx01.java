...
public class ThrowsEx01 {
	...
	public static void main(String[] args) {
		...
		//메서드에서 예외처리 - throws
		//throws구문이 붙어있는 메서드 or 생성자를 호출할 때는 예외를 대신 처리해야합니다.
		...
		try {
			...
			//에외처리를 하면 예외의 내용을 알수가 없기 때문에,
			// 예외의 내용을 확인하기 위해서 catch영역에서는 항상 사용한다.(e.printStackTrace)
			e.printStackTrace(); 
		}
	...
	//static
	private static String[] arr = {"안녕하세요", "hello", "니하오","고니찌와"}; // 멤버변수
